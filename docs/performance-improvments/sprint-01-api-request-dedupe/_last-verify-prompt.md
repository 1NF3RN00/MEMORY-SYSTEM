# Performance sprint run — sprint-01-api-request-dedupe — verify
...
2. Edit `C:/Users/james/semantic-core/docs/performance-improvments/sprint-01-api-request-dedupe/outcomes.md` as you go (Verification summary + Score + Measurements).
