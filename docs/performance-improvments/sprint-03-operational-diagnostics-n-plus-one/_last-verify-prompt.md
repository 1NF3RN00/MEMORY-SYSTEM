# Performance sprint run — sprint-03-operational-diagnostics-n-plus-one — verify
...
2. Edit `C:/Users/james/semantic-core/docs/performance-improvments/sprint-03-operational-diagnostics-n-plus-one/outcomes.md` as you go (Verification summary + Score + Measurements).
