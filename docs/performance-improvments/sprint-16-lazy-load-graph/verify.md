# Sprint-16 — Verification: Lazy-Load Relationship Graph
...
Verification only for: **Lazy-Load Relationship Graph**. Do not re-implement unless tests expose a defect.

## Testing framework

- [ ] 1. Waterfall: graph after telemetry or visible
- [ ] 2. Map renders when visible
