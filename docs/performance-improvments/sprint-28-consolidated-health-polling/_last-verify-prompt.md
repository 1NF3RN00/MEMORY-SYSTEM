# Performance sprint run — sprint-28-consolidated-health-polling — verify
...
2. Edit `C:/Users/james/semantic-core/docs/performance-improvments/sprint-28-consolidated-health-polling/outcomes.md` as you go (Verification summary + Score + Measurements).
