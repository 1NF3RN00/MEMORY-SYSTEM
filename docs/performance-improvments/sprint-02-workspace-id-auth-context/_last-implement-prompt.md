# Performance sprint run — sprint-02-workspace-id-auth-context — implement
...
2. Edit `C:/Users/james/semantic-core/docs/performance-improvments/sprint-02-workspace-id-auth-context/outcomes.md` as you go (Implementation summary + Anti-objectives avoided).
